    ...
    public partial class BuyMedicineUserControl1 : UserControl
    {
        ...
        private void btnAddStock_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtAddMedicineIdentityNo.Clear();
                txtAddMedicineDetails.Clear();
                txtAddMedicineCompony.Clear();
                txtAddMedicineName.Text = "";
                txtAddMedicinePrice.Clear();
                txtAddMedicineCompony.Clear();
                txtAdMedicineQuantity.Clear();
                cmbAddMedicinrType.Text = "";
        ...
        {
            MessageBox.Show("hello There i am in the tabpage2 event.");
        }
        ...
        //private void txtAddMedicineName_Click(object sender, EventArgs e)
        //{
        //    string qry = "Select max(IdentityNo) from Medicine";
        //    SqlDataReader reader = ConnectionManager.GetConnectedData(qry);

        //    //     MessageBox.Show("" + reader.GetValue(0));
        //    while (reader.Read())
        //    {
        //        txtAddMedicineIdentityNo.Text = reader["IdentityNo"].ToString();
        //    }
        //    int id = int.Parse(txtAddMedicineIdentityNo.Text);
        //    id = id + 1;
        //    txtAddMedicineIdentityNo.Text = id.ToString();
        //}

        private void txtAddMedicineName_Click_1(object sender, EventArgs e)
        {
            //when i click on box id will increment by 1 in last id.

            string qry = "Select max(IdentityNo) from Medicine";
            SqlCommand reader = new SqlCommand(qry, ConnectionManager.GetConnection());
            int id = (int)reader.ExecuteScalar();
            id = id + 1;
            txtAddMedicineIdentityNo.Text = id.ToString();
        }
