...
namespace Medical_Store
{
    ...
    {
        DataTable salesDataTable;        public SellMedicineUserControl()
        {
            InitializeComponent();
        }
              ...
              //
                ...
                else
                {
                    ...
                    if (int.Parse(lblquantity.Text) >= int.Parse(txtEnterQuantity.Text))
                    {
                        ...
                        salesStock.ItemID = lblID.Text;
                        salesStock.ItemName = lblMedicineName.Text;
            ...
            //{
                ...
                if (gdvSell.Rows.Count >= 1)
                {
                    ...
                    foreach (var item in salesList)
                    {
                        ...
                        Medicine.UpdateMedicineOnSell(item.Quantity, item.ItemID);
                    }
                }
                else
                {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            gdvSell.DrawToBitmap(objBitmap, new Rectangle(0, 0, this.gdvSell.Width, this.gdvSell.Height));
        ...
        private void Edit_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("jgyyuytutyu       thttyr");
        }
